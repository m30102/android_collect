...
public class FLogger {
	...
	private static final String TAG_DEFAULT = "flogger";
	
	public static final String UTIL_TAG = "f_utils";
	public static final String HTTP_TAG = "f_http";
	public static final String COMMON_TAG = "flogger";
